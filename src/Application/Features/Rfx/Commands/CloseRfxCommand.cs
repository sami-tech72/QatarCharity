...
public class CloseRfxCommand(IRfxRepository repository)
{
    public async Task<Result<RfxDetailResponse>> HandleAsync(Guid id, string currentUserId, bool isAdmin)
    {
