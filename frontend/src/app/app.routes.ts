...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/workflow-configuration/workflow-configuration.component').then(
        (m) => m.WorkflowConfigurationComponent,
      ),
  },
  {
    ...
    loadComponent: () =>
      import('./pages/document-templates/document-templates.component').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/system-integrations/system-integrations.component').then(
        (m) => m.SystemIntegrationsComponent,
      ),
  },
  {
    path: 'audit-logs',
